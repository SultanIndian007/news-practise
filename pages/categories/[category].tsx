    ...
    return ( 
        <>
            ...
            <main>
                <h1>{title}</h1>
                <Alert>
                This page uses <strong>getServerSideProps</strong> for very high page loading speed and 
                <strong>incremental static generation</strong>to show data not older than <strong>5 minutes</strong>.
                </Alert>
