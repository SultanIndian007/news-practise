    ...
    return ( 
        <>
            ...
            <main> 
                <h1>Search News</h1>
                <Alert>
                    This page uses <strong>client-side data fetching</strong>to show fresh data every search.
                ...
                <Form onSubmit={handleSubmit}>
                    <Form.Group className="mb-3" controlId="search-input">
                        ...
                        <Form.Control 
                            name="searchQuery"
                            placeholder="Ex - politics, sports, ..."
                        >
                        </Form.Control>
                    </Form.Group>
                ...
                <div className="d-flex flex-column align-items-center">
                    {searchResults && <Spinner animation="border" />}
